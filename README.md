...
- **Rozenite** - создание плагинов для DevTools
...
mobx-debuger/        # Rozenite плагин для отладки MobX
    ├── src/         # Исходный код плагина
    │   ├── mobx-debugger.tsx  # Веб-панель DevTools
    │   ├── react-native/      # Код для RN приложения
    │   └── store-registry.ts  # Реестр MobX сторов
...
- **[video4.md](./video4.md)** - Создание плагина для Rozenite DevTools на примере mobx-debuger
